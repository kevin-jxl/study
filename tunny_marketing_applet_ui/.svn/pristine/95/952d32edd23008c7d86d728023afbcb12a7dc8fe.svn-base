    ...
    <div class="app-container calendar-list-container">
        ...
        <el-dialog :visible.sync="dialogFormVisible" width="35%">
            ...
            <el-form :model="form"
                     ...
                     label-width="100px">
                                  ...
                                  prop="bookDate">
                                                    <el-input v-model="form.bookDate"
                                      placeholder="预约日期"></el-input>
                                            </el-form-item>
                                    <el-form-item label="预约时间"
                                  prop="bookTime">
                                                    <el-input v-model="form.bookTime"
                                      placeholder="预约时间"></el-input>
                                            </el-form-item>
        ...
        <el-dialog title="字段选择" width="480px"
            ...
            <el-checkbox-group v-model="checkboxVal">
                                    ...
                                    <el-checkbox label="userName">用户姓名</el-checkbox>
                                    <el-checkbox label="customerId">客户id</el-checkbox>
                                    <el-checkbox label="userSex">用户性别</el-checkbox>
                                    <el-checkbox label="userPhone">电话</el-checkbox>
                                    <el-checkbox label="bookDate">预约日期</el-checkbox>
                                    <el-checkbox label="bookTime">预约时间</el-checkbox>
...
<script>
    import { fetchList, getObj, addObj, putObj, delObj,delObjs } from '@/api/marketingpcapi/hzmpbookingroom'
    ...
    const defaultFormThead = [
                    ...
                    { key: 'userSex', label: '用户性别' },
                    { key: 'userPhone', label: '电话' },
                    { key: 'bookDate', label: '预约日期' },
                    { key: 'bookTime', label: '预约时间' },
