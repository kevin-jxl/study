    ...
    <div class="app-container calendar-list-container">
            ...
            <el-table
                ...
                <el-table-column align="center" v-for="tableitem in formThead" :key="tableitem.key" :label="tableitem.label">
                    <template slot-scope="scope" > 
                        <label v-if="tableitem.key=='photoType'">

                        </label>
                        <label v-else> {{ scope.row[tableitem.key] }}</label>
                    </template>
        ...
        <el-dialog :visible.sync="dialogFormVisible" width="35%">
            ...
            <el-form :model="form"
                     ...
                     label-width="100px">
                                    <el-form-item label=""
                                  prop="rowId">
                                                    <el-input v-model="form.rowId"
                                      placeholder=""></el-input>
                                            </el-form-item>
                                    <el-form-item label="图片名"
                                  prop="name">
                                                    <el-input v-model="form.name"
                                      placeholder="图片名"></el-input>
                                            </el-form-item>
                                    <el-form-item label="图片描述"
                                  prop="photoDescribe">
                                                    <el-input v-model="form.photoDescribe"
                                      placeholder="图片描述"></el-input>
                                            </el-form-item>
                                    <el-form-item label="项目发布id"
                                  prop="projectPublishId">
                                                    <el-input v-model="form.projectPublishId"
                                      placeholder="项目发布id"></el-input>
                                            </el-form-item>
                                    <el-form-item label="图片类型"
                                  prop="photoType">
                                                    <el-input v-model="form.photoType"
                                      placeholder="图片类型"></el-input>
                                            </el-form-item>
                                  ...
                                  prop="updateBy">
                                      ...
                                      placeholder="修改人"></el-input>
                                            </el-form-item>
                                    <el-form-item label="修改时间"
                                  prop="updateDate">
                                                    <el-date-picker v-model="form.updateDate"
                                            type="datetime"
                                            placeholder="修改时间"></el-date-picker>
                                            </el-form-item>
                                    <el-form-item label="1：有效，0：无效"
                                  prop="activeFlag">
                                                    <el-input v-model="form.activeFlag"
                                      placeholder="1：有效，0：无效"></el-input>
                                            </el-form-item>
                                    <el-form-item label="图片url"
                                  prop="photoUrl">
                                                    <el-input v-model="form.photoUrl"
                                      placeholder="图片url"></el-input>
                                            </el-form-item>
                                    <el-form-item label="排序字段（越大越靠后）"
                                  prop="orderShort">
                                                    <el-input v-model="form.orderShort"
                                      placeholder="排序字段（越大越靠后）"></el-input>
                                            </el-form-item>
                                    <el-form-item label="外部链接"
                                  prop="outsideUrl">
                                                    <el-input v-model="form.outsideUrl"
                                      placeholder="外部链接"></el-input>
                                            </el-form-item>
                                    <el-form-item label="附件表id"
                                  prop="attachmentId">
                                                    <el-input v-model="form.attachmentId"
                                      placeholder="附件表id"></el-input>
                                            </el-form-item>
                            </el-form>
            <div slot="footer"
                 class="dialog-footer">
        ...
        <el-dialog title="字段选择" width="480px"
            ...
            <el-checkbox-group v-model="checkboxVal">
                                    ...
                                    <el-checkbox label="rowId"></el-checkbox>
                                    <el-checkbox label="name">图片名</el-checkbox>
                                    <el-checkbox label="photoDescribe">图片描述</el-checkbox>
                                    <el-checkbox label="projectPublishId">项目发布id</el-checkbox>
                                    <el-checkbox label="photoType">图片类型</el-checkbox>
                                    <el-checkbox label="createDate">创建时间</el-checkbox>
                                    <el-checkbox label="createBy">创建人</el-checkbox>
                                    <el-checkbox label="updateBy">修改人</el-checkbox>
                                    <el-checkbox label="updateDate">修改时间</el-checkbox>
                                    <el-checkbox label="activeFlag">1：有效，0：无效</el-checkbox>
                                    <el-checkbox label="photoUrl">图片url</el-checkbox>
                                    <el-checkbox label="orderShort">排序字段（越大越靠后）</el-checkbox>
                                    <el-checkbox label="outsideUrl">外部链接</el-checkbox>
                                    <el-checkbox label="attachmentId">附件表id</el-checkbox>
...
<script>
    import { fetchList, getObj, addObj, putObj, delObj,delObjs } from '@/api/marketingpcapi/hzmpphotomanage'
    ...
    const defaultFormThead = [
                    // { key: 'rowId', label: '' },
                    { key: 'name', label: '图片名' },
                    { key: 'photoDescribe', label: '图片描述' },
                    // { key: 'projectPublishId', label: '项目发布id' },
                    { key: 'photoType', label: '图片类型' },
                    { key: 'createDate', label: '创建时间' },
                    // { key: 'createBy', label: '创建人' },
                    // { key: 'updateBy', label: '修改人' },
                    // { key: 'updateDate', label: '修改时间' },
                    // { key: 'activeFlag', label: '1：有效，0：无效' },
                    { key: 'photoUrl', label: '图片url' },
                    { key: 'orderShort', label: '排序字段' },
                    { key: 'outsideUrl', label: '外部链接' },
                    // { key: 'attachmentId', label: '附件表id' },
            ];
    //默认当前选中的显示列
    ...
    export default {
        ...
        methods: {
            ...
            handleEdit(row, index) {
                getObj(row.rowId).then(response => {
