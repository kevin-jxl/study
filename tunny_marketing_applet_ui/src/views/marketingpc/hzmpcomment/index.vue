...
<!--            </el-table>-->
          ...
          >
            ...
            <el-table-column
              ...
              label="审批状态">
              <template slot-scope="scope">
                {{scope.row.approvalStatus | statusFilter}}
              </template>
            </el-table-column>
            <el-table-column
              prop="createDate"
            ...
            <el-table-column
              ...
              label="有效状态">
              <template slot-scope="scope">
                {{scope.row.activeFlag | activeFlagFilter}}
              </template>
            </el-table-column>
...
<!--            &lt;!&ndash;操作列&ndash;&gt;&ndash;&gt;-->
        ...
        <el-dialog :visible.sync="dialogFormVisible" width="35%">
          ...
          <el-form :model="form"
                     ...
                     label-width="100px">
                                  ...
                                  prop="approverlId">
                                                    <el-input v-model="form.approverlId"
                                      placeholder="审批人id"></el-input>
                                            </el-form-item>
                                    <el-form-item label="审批时间"
                                  prop="approvaTime">
                                                    <el-date-picker v-model="form.approvaTime"
                                            type="datetime"
                                            placeholder="审批时间"></el-date-picker>
                                            </el-form-item>
                                  ...
                                  prop="stars">
                                                    <el-input v-model="form.stars"
                                      placeholder="星星数"></el-input>
                                            </el-form-item>
                            </el-form>
            <div slot="footer"
                 class="dialog-footer">
        ...
        <el-dialog title="字段选择" width="480px"
            ...
            <el-checkbox-group v-model="checkboxVal">
                                    ...
                                    <el-checkbox label="commentContent">评论内容</el-checkbox>
                                    <el-checkbox label="approvalStatus">审批状态</el-checkbox>
                                    <el-checkbox label="customerId">客户id</el-checkbox>
                                    <el-checkbox label="projectPublishId">项目发布id</el-checkbox>
                                    <el-checkbox label="approverlId">审批人id</el-checkbox>
                                    <el-checkbox label="approvaTime">审批时间</el-checkbox>
                                    <el-checkbox label="createDate">创建时间</el-checkbox>
                                    <el-checkbox label="activeFlag">内容状态</el-checkbox>
                                    <el-checkbox label="orderShort">排序字段</el-checkbox>
                                    <el-checkbox label="stars">星星数</el-checkbox>
...
<script>
  import {addObj, delObj, delObjs, fetchList, getObj, putObj} from '@/api/marketingpcapi/hzmpcomment'
  ...
  //表单迭代展示的列
    const defaultFormThead = [
                    ...
                    { key: 'approverlId', label: '审批人id' },
                    { key: 'approvaTime', label: '审批时间' },
                    { key: 'createDate', label: '创建时间' },
                    { key: 'activeFlag', label: '内容状态' },
                    { key: 'orderShort', label: '排序字段（越大越靠后）' },
                    { key: 'stars', label: '星星数' },
            ];
    //默认当前选中的显示列
