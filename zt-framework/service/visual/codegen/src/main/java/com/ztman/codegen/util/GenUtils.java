package com.ztman.codegen.util;

import cn.hutool.core.date.DateUtil;
import cn.hutool.core.io.IoUtil;
import cn.hutool.core.util.CharsetUtil;
import cn.hutool.core.util.StrUtil;
import com.ztman.codegen.entity.ColumnEntity;
import com.ztman.codegen.entity.GenConfig;
import com.ztman.codegen.entity.TableEntity;
...
//		templates.add("template/api.js.vm");
	...
	private static String getFileName(String template, String className, String packageName, String moduleName) {
		String packagePath = "ztman" + File.separator + "src" + File.separator + "main" + File.separator + "java" + File.separator;
		...
		if (template.contains(MAPPER_XML_VM)) {
			return "ztman" + File.separator + "src" + File.separator + "main" + File.separator + "resources" + File.separator + "mapper" + File.separator + className + "Mapper.xml";
		}
...
//			return "ui" + File.separator + "src" + File.separator + "views" +
//				File.separator + moduleName + File.separator + className.toLowerCase() + File.separator + "index.vue";
//		}
//
//		if (template.contains(API_JS_VM)) {
//			return "ui" + File.separator + "src" + File.separator + "api" + File.separator + className.toLowerCase() + ".js";
//		}
//
//		if (template.contains(CRUD_JS_VM)) {
//			return "ui" + File.separator + "src" + File.separator + "const" +
