package com.ztman.common.mq.config;

import javax.annotation.PostConstruct;

import com.ztman.common.mq.content.MessageEvent;
import com.ztman.common.mq.content.RocketMQProperties;
...
public class RocketMQConfiguration {
    ...
    public DefaultMQProducer defaultProducer() throws MQClientException {
        ...
        producer.start();
        log.info("消息普通生产者 server is starting....");
        return producer;
    }
    ...
    public TransactionMQProducer transactionProducer() throws MQClientException {
        ...
        producer.setRetryTimesWhenSendAsyncFailed(10);
        producer.start();
        log.info("事务消息生产者 server is starting....");
        return producer;
    }
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    log.info("消费者 server is starting....");
