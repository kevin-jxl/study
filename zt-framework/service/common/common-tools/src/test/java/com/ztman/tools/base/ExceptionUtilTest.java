...
import com.ztman.tools.base.type.CloneableException;
import com.ztman.tools.base.type.CloneableRuntimeException;
import com.ztman.tools.base.type.UncheckedException;
...
public class ExceptionUtilTest {
	...
	public void staticException() {
		...
		assertThat(ExceptionUtil.stackTraceText(TIMEOUT_EXCEPTION2)).hasLineCount(2)
				.contains("CloneableException: Timeout")
				.contains("at ExceptionUtilTest.hello(Unknown Source)");
		...
		assertThat(ExceptionUtil.stackTraceText(timeoutException)).hasLineCount(2)
				.contains("CloneableException: Timeout for 30ms")
				.contains("at ExceptionUtilTest.hello(Unknown Source)");

		assertThat(ExceptionUtil.stackTraceText(TIMEOUT_EXCEPTION3)).hasLineCount(2)
				.contains("CloneableRuntimeException: Timeout")
				.contains("at ExceptionUtilTest.hello(Unknown Source)");
		...
		assertThat(ExceptionUtil.stackTraceText(timeoutRuntimeException)).hasLineCount(2)
				.contains("CloneableRuntimeException: Timeout for 40ms")
				.contains("at ExceptionUtilTest.hello(Unknown Source)");
