	...
	<div class="app-container calendar-list-container">
		<div class="filter-container crud-menu clearfix">
			...
			<div class="form_search clearfix" style="padding:0 10px;">
				<el-form :inline="true" :model="listQuery" class="search-form-inline">
					<el-form-item label="输入搜索:">
						<el-input v-model="listQuery.name" placeholder="流程项"></el-input>
					</el-form-item>
					<el-form-item>
			...
			<el-button class="float-fr" type="primary" @click="handleCreate" icon="edit" size="mini" style="margin-bottom:10px;"
			 v-if="userData.permissions.includes('sys_firm_add')">添加业务流
			</el-button>
		</div>
		<div style="height:calc(100% - 120px)">
			<z-table :data="tableData" @size-change="handleSizeChange" @current-change="handleCurrentChange" :total="total">
				<div slot="table-column">
					...
					<el-table-column align="center" label="流程项">
					...
					<el-table-column label="操作" align="center" width="280" v-if="userData.permissions.includes('sys_firm_edit') || userData.permissions.includes('sys_firm_del')">
						<template slot-scope="scope">
							<el-button size="mini" type="text" v-if="userData.permissions.includes('sys_firm_edit')" @click="handleUpdate(scope.row,'update')">编辑</el-button>
							<el-button size="mini" type="text" v-if="userData.permissions.includes('sys_firm_edit')" @click="handleUpdate(scope.row,'info')">详情</el-button>
							<el-button size="mini" type="text" v-if="userData.permissions.includes('sys_firm_edit')" @click="handleUpdate(scope.row)">未定</el-button>
		...
		<div class="dialog_mask_mine">
			<el-dialog :visible.sync="dialogFormVisible" width="45%" :close-on-click-modal="false">
                <div slot="title">
						...
						<el-row :gutter="20">
							<el-col :span="12">
								<el-form-item label="企业名称" :label-width="formLabelWidth" prop="name">
									<el-input v-model="form.name" :maxlength="20" autocomplete="off" :disable="disableds"></el-input>
								</el-form-item>
							</el-col>
							<el-col :span="12">
								<el-form-item label="企业编号" :label-width="formLabelWidth" prop="code">
									<el-input v-model="form.code" autocomplete="off" :disable="disableds"></el-input>
								</el-form-item>
							</el-col>
							<el-col :span="12">
								<el-form-item label="负责人" :label-width="formLabelWidth" prop="adminName">
									<el-input v-model="form.adminName" :maxlength="20" autocomplete="off" :disable="disableds"></el-input>
								</el-form-item>
							</el-col>
							<el-col :span="12">
								<el-form-item label="联系方式" :label-width="formLabelWidth" prop="phone">
									<el-input v-model="form.phone" autocomplete="off" :maxlength="11" :disable="disableds"></el-input>
								</el-form-item>
							</el-col>

						</el-row>
						<el-form-item label="备注信息" :label-width="formLabelWidth" style="width: 100%;">
							<el-input type="textarea" v-model="form.description" autocomplete="off" :maxlength="200" :rows="4" :disable="disableds"></el-input>
						</el-form-item>
					</el-form>
				</div>
